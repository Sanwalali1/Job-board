...
<html class="no-js" lang="zxx">
   ...
   <body>
                                ...
                                <div class="main-menu">
                                    <nav class="d-none d-lg-block">
                                        <ul id="navigation">
                                            ...
                                            <li><a href="about.php" style="color: #FB246A;">About</a></li>
    ...
    <main>
        ...
        <div class="apply-process-area  pb-150">
            <div class="container">
                <!-- Section Tittle -->
                <div class="row">
                    <div class="col-lg-12">
        ...
        <div class="online-cv cv-bg section-overly pt-90 pb-120 mb-100"  data-background="assets/img/gallery/cv_bg.jpg">
            <div class="container">
